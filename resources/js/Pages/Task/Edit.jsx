...
export default function Create({ auth, task, projects, users }) {
    const { data, setData, post, errors, reset } = useForm({
        ...
        _method: "PUT", // For existing Tasks
    });
                        ...
                        <div className="p-6 text-gray-900 dark:text-gray-100">
                            <form onSubmit={onSubmit} className="p-4 sm:p-8 bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg">
                                ...
                                <div>
                                    ...
                                    {data.project_id}
                                    <SelectInput name='project_id' id='task_project_id' value={data.project_id} className='mt-1 block w-full' onChange={(e) => setData('project_id', e.target.value)} >
                                ...
                                <div className="mt-4">
                                    ...
                                    <SelectInput name='assigned_user_id' id='task_assigned_user' value={data.assigned_user_id} className='mt-1 block w-full' onChange={(e) => setData('assigned_user_id', e.target.value)}>
